...
// Constructors
+ (MGTwitterEngine *)twitterEngineWithDelegate:(__weak NSObject <MGTwitterEngineDelegate> *)delegate;
- (MGTwitterEngine *)initWithDelegate:(__weak NSObject <MGTwitterEngineDelegate> *)delegate;
